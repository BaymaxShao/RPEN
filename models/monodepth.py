...
def resnet_multiimage_input(num_layers, pretrained=True, num_input_images=2):
...
class monodepth(nn.Module):
    def __init__(self):
        ...
        self.encoder = ResnetEncoder(18, True, 2)
        self.decoder = PoseDecoder(self.encoder.num_ch_enc, 1, 1)

    def forward(self, img1, img2):
        feats = self.encoder(torch.cat([img1, img2], 1))
